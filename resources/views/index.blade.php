                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                ...
                                <textarea  class="form-control force-opaque textarea-limited required" placeholder="Máximo de 450 caracteres." rows="10" ,="" maxlength="450" name="Mensaje"  style="color: #0f0f0f;">{{ old('Mensaje') }}</textarea>
                                  <div class="row">
                                    <div class="col-md-8">
                                      <label style="color: #0f0f0f;font-weight: 500;">Información requerida</label>
            ...
            <div class="row">
              <div class="col-md-7">
                <ul class="links-vertical">
                  ...
                  <li>
                    <a>
                      Calle 17 número 106 por 24 y 26 colonia itzimná cp. 97100
                    </a>
                  </li>
                  <li>
                    <a style="font-weight: bold">
              ...
              <div class="col-md-5">
                <ul class="links-vertical">
                  ...
                  <li>
                    <div class="row">
                      <div class="col-md-4">
                        <a href="tel:+529999449975">9999 449975</a>
                      </div>
                      <div class="col-md-1">
                        <a class="formatText2">/</a>
                      </div>
                      <div class="col-md">
                        <a href="tel:+529992577212">9992 577212</a>
                      </div>
                    </div>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="{{url('https://wa.me/5219993685092')}}" title="Ir a la App" target="_blank"> 
                      9993 685092
                    </a>
                  </li>
                  <li>
