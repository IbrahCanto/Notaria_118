      ...
      <div style="max-width: 600px; margin: 0 auto;" class="email-container">
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          <td valign="middle" class="hero bg_white" style="padding: 3em 0 2em 0;">
            <img src="./assets/img/Logo_118_3.png" alt="" style="width: 300px; max-width: 236px; height: auto; margin: auto; display: block;">
          </td>
				  <tr>
            <td valign="middle" class="hero bg_white" style="padding: 2em 0 4em 0;">
              <table>
            	  <tr>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <h4>Estimado/a <span><b>{{ $datosFormulario['Nombre'] }}</b></span>,</h4>  
                          <h4>Es un placer saludarte. Queremos informarte que hemos recibido correctamente tu mensaje y estamos en proceso de revisarlo. Apreciamos tu interés en contactarnos y te agradecemos por elegirnos.</h4>  
                          <h4>Por favor, ten en cuenta que nuestro equipo se esfuerza por brindar respuestas rápidas y efectivas. Te contactaremos tan pronto como sea posible para atender tus consultas y comentarios.</h4>  
                          <h4>Gracias por elegirnos y por confiar en nosotros.</h4>  
                          <h4>Atentamente,</h4> 
                          <h3 style=" font-weight: bold;">Notaría Publica 118</h3>  
                        </div>
                      </div>
            			  </div>
            		  </td>
