...
class PagesController extends Controller
{
    ...
    public function recibir(Request $request) {
        ...
        if ($validator->passes()) {
            ...
            $correoNotaria = env('MAIL_USERNAME');
            $correoDestino = $registro_mensaje_reg->Email;
            ...
            Mail::to([$correoNotaria])->send(new correoNotaria118($datosFormulario));
            Mail::to([$correoDestino])->send(new correoDestinatario($datosFormulario));
